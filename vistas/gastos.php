              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistadogasto" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            <th>Opciones</th>
                            <th>Cantidad</th>
                            <th>Descripción</th>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="hidden" name="tipo_transacion" id="tipo_transacion" value="2">
